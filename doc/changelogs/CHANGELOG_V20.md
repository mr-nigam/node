...
* \[[`4d59012e07`](https://github.com/nodejs/node/commit/4d59012e07)] - **doc**: add JonasBa to collaborators (Jonas Badalic) [#58355](https://github.com/nodejs/node/pull/58355)
* \[[`a5cf070002`](https://github.com/nodejs/node/commit/a5cf070002)] - **doc**: add puskin to collaborators (Giovanni Bucci) [#58308](https://github.com/nodejs/node/pull/58308)
...
* \[[`1d9be185c8`](https://github.com/nodejs/node/commit/1d9be185c8)] - **build**: fix pointer compression builds (Joyee Cheung) [#58171](https://github.com/nodejs/node/pull/58171)
* \[[`71de35c068`](https://github.com/nodejs/node/commit/71de35c068)] - **build**: disable v8\_enable\_pointer\_compression\_shared\_cage on non-64bit (Shelley Vohr) [#58867](https://github.com/nodejs/node/pull/58867)
...
* \[[`8923dd250f`](https://github.com/nodejs/node/commit/8923dd250f)] - **debugger**: fix behavior of plain object exec in debugger repl (Dario Piotrowicz) [#57498](https://github.com/nodejs/node/pull/57498)
...
* \[[`b4a60e1d98`](https://github.com/nodejs/node/commit/b4a60e1d98)] - **dns**: remove redundant code using common variable (Deokjin Kim) [#57386](https://github.com/nodejs/node/pull/57386)
* \[[`7dbfeb5372`](https://github.com/nodejs/node/commit/7dbfeb5372)] - **dns**: set timeout to 1000ms when timeout < 0 (theanarkh) [#58441](https://github.com/nodejs/node/pull/58441)
...
* \[[`a1e8547d88`](https://github.com/nodejs/node/commit/a1e8547d88)] - **doc**: add review guidelines for collaborator nominations (Antoine du Hamel) [#57449](https://github.com/nodejs/node/pull/57449)
* \[[`4854bbfef9`](https://github.com/nodejs/node/commit/4854bbfef9)] - **doc**: explicit mention arbitrary code execution as a vuln (Rafael Gonzaga) [#57426](https://github.com/nodejs/node/pull/57426)
* \[[`4d59012e07`](https://github.com/nodejs/node/commit/4d59012e07)] - **doc**: add JonasBa to collaborators (Jonas Badalic) [#58355](https://github.com/nodejs/node/pull/58355)
* \[[`a5cf070002`](https://github.com/nodejs/node/commit/a5cf070002)] - **doc**: add puskin to collaborators (Giovanni Bucci) [#58308](https://github.com/nodejs/node/pull/58308)
* \[[`0aaef93ddd`](https://github.com/nodejs/node/commit/0aaef93ddd)] - **doc**: add ovflowd back to core collaborators (Claudio W.) [#58911](https://github.com/nodejs/node/pull/58911)
...
* \[[`00f794cd69`](https://github.com/nodejs/node/commit/00f794cd69)] - **http**: fix keep-alive not timing out after post-request empty line (Shima Ryuhei) [#58178](https://github.com/nodejs/node/pull/58178)
* \[[`ef4539e94c`](https://github.com/nodejs/node/commit/ef4539e94c)] - **http**: coerce content-length to number (Marco Ippolito) [#57458](https://github.com/nodejs/node/pull/57458)
* \[[`c44fcf3602`](https://github.com/nodejs/node/commit/c44fcf3602)] - **http2**: fix check for `frame->hd.type` (hanguanqiang) [#57644](https://github.com/nodejs/node/pull/57644)
* \[[`61d849f80a`](https://github.com/nodejs/node/commit/61d849f80a)] - **lib**: fixup incorrect argument order in assertEncoding (James M Snell) [#57177](https://github.com/nodejs/node/pull/57177)
...
* \[[`f340c1d70c`](https://github.com/nodejs/node/commit/f340c1d70c)] - **module**: throw error when re-runing errored module jobs (Joyee Cheung) [#58957](https://github.com/nodejs/node/pull/58957)
* \[[`96a2008eff`](https://github.com/nodejs/node/commit/96a2008eff)] - **module**: allow cycles in require() in the CJS handling in ESM loader (Joyee Cheung) [#58598](https://github.com/nodejs/node/pull/58598)
* \[[`de4a7e49e1`](https://github.com/nodejs/node/commit/de4a7e49e1)] - **module**: clarify cjs global-like error on ModuleJobSync (Carlos Espa) [#56491](https://github.com/nodejs/node/pull/56491)
* \[[`d2d73b44ac`](https://github.com/nodejs/node/commit/d2d73b44ac)] - **module**: handle instantiated async module jobs in require(esm) (Joyee Cheung) [#58067](https://github.com/nodejs/node/pull/58067)
* \[[`1186650108`](https://github.com/nodejs/node/commit/1186650108)] - **module**: fix incorrect formatting in require(esm) cycle error message (haykam821) [#57453](https://github.com/nodejs/node/pull/57453)
* \[[`e4bd3f5cad`](https://github.com/nodejs/node/commit/e4bd3f5cad)] - **module**: handle cached linked async jobs in require(esm) (Joyee Cheung) [#57187](https://github.com/nodejs/node/pull/57187)
* \[[`b3f522b2b1`](https://github.com/nodejs/node/commit/b3f522b2b1)] - **module**: improve error message from asynchronicity in require(esm) (Joyee Cheung) [#57126](https://github.com/nodejs/node/pull/57126)
* \[[`a30516bcb1`](https://github.com/nodejs/node/commit/a30516bcb1)] - **module**: handle .mjs in .js handler in CommonJS (Joyee Cheung) [#55590](https://github.com/nodejs/node/pull/55590)
* \[[`3bc04971f5`](https://github.com/nodejs/node/commit/3bc04971f5)] - **module**: fix require.resolve() crash on non-string paths (Aditi) [#56942](https://github.com/nodejs/node/pull/56942)
* \[[`ecfca315b6`](https://github.com/nodejs/node/commit/ecfca315b6)] - **os**: fix GetInterfaceAddresses memory lieaky (theanarkh) [#58940](https://github.com/nodejs/node/pull/58940)
...
* \[[`7d0b9adfb9`](https://github.com/nodejs/node/commit/7d0b9adfb9)] - **readline**: fix unresolved promise on abortion (Daniel Venable) [#54030](https://github.com/nodejs/node/pull/54030)
* \[[`6457583488`](https://github.com/nodejs/node/commit/6457583488)] - **repl**: avoid deprecated `require.extensions` in tab completion (baki gul) [#58653](https://github.com/nodejs/node/pull/58653)
* \[[`8ffee851f5`](https://github.com/nodejs/node/commit/8ffee851f5)] - **repl**: fix tab completion not working with computer string properties (Dario Piotrowicz) [#58709](https://github.com/nodejs/node/pull/58709)
* \[[`f02e3fb6f3`](https://github.com/nodejs/node/commit/f02e3fb6f3)] - **src**: do not format single string argument for THROW\_ERR\_\* (Joyee Cheung) [#57126](https://github.com/nodejs/node/pull/57126)
* \[[`ac7c3a9b69`](https://github.com/nodejs/node/commit/ac7c3a9b69)] - **src**: fixup errorhandling more in various places (James M Snell) [#57852](https://github.com/nodejs/node/pull/57852)
* \[[`7bf05c3e6d`](https://github.com/nodejs/node/commit/7bf05c3e6d)] - **src**: fix module buffer allocation (X-BW) [#57738](https://github.com/nodejs/node/pull/57738)
* \[[`75f9197cae`](https://github.com/nodejs/node/commit/75f9197cae)] - **src**: fix build when using shared simdutf (Antoine du Hamel) [#58407](https://github.com/nodejs/node/pull/58407)
* \[[`536275fdaa`](https://github.com/nodejs/node/commit/536275fdaa)] - **src**: fix possible dereference of null pointer (Eusgor) [#58459](https://github.com/nodejs/node/pull/58459)
* \[[`b55ba67c29`](https://github.com/nodejs/node/commit/b55ba67c29)] - **src**: fix FIPS init error handling (Tobias Nießen) [#58379](https://github.com/nodejs/node/pull/58379)
* \[[`18f003bc16`](https://github.com/nodejs/node/commit/18f003bc16)] - **src**: fix -Wunreachable-code in src/node\_api.cc (Shelley Vohr) [#58901](https://github.com/nodejs/node/pull/58901)
* \[[`e12d0d35e5`](https://github.com/nodejs/node/commit/e12d0d35e5)] - **tools**: update coverage GitHub Actions to fixed version (Rich Trott) [#59512](https://github.com/nodejs/node/pull/59512)
...
* \[[`35e1258559`](https://github.com/nodejs/node/commit/35e1258559)] - **util**: fix formatting of objects with built-in Symbol.toPrimitive (Shima Ryuhei) [#57832](https://github.com/nodejs/node/pull/57832)
* \[[`ccd1db088c`](https://github.com/nodejs/node/commit/ccd1db088c)] - **util**: fix parseEnv incorrectly splitting multiple ‘=‘ in value (HEESEUNG) [#57421](https://github.com/nodejs/node/pull/57421)
* \[[`5923737f1e`](https://github.com/nodejs/node/commit/5923737f1e)] - **v8**: fix missing callback in heap utils destroy (Ruben Bridgewater) [#58846](https://github.com/nodejs/node/pull/58846)
* \[[`2d8d96148a`](https://github.com/nodejs/node/commit/2d8d96148a)] - **vm**: import call should return a promise in the current context (Chengzhong Wu) [#58309](https://github.com/nodejs/node/pull/58309)
* \[[`03235b9e31`](https://github.com/nodejs/node/commit/03235b9e31)] - **win,build**: fix MSVS v17.14 compilation issue (StefanStojanovic) [#58902](https://github.com/nodejs/node/pull/58902)
...
* \[[`54339e76ab`](https://github.com/nodejs/node/commit/54339e76ab)] - **zlib**: remove mentions of unexposed Z\_TREES constant (Jimmy Leung) [#58371](https://github.com/nodejs/node/pull/58371)
* \[[`8f8b8ce401`](https://github.com/nodejs/node/commit/8f8b8ce401)] - **zlib**: fix pointer alignment (jhofstee) [#57727](https://github.com/nodejs/node/pull/57727)
